 ...
 * 屏幕宽度
 */
inline val screenWidth: Int get() = globalContext.resources.displayMetrics.widthPixels

/**
 * 屏幕高度
 */
inline val screenHeight: Int get() = globalContext.resources.displayMetrics.heightPixels
...
fun Context.getPrimaryColor():Int{
    return getThemeAttrValue(androidx.appcompat.R.attr.colorPrimary)
}

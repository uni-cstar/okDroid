 ...
 */
@JvmOverloads
fun Context.startIntentForDial(tel: String? = null) {
...
fun Context.startIntentForSettings() {
    startIntentForAction(Settings.ACTION_SETTINGS)
}
 ...
 */
private fun Context.startIntentForAction(action: String, data: Uri? = null) {

...
import libcore.BasConfigurator
import unics.okdroid.tools.net.DroidURLCoder
import unics.okdroid.util.Base64
import libcore.lang.*
import libcore.lang.toBase64DecodeString
import libcore.lang.toBase64EncodeString
import libcore.lang.toUrlDecode
import libcore.lang.toUrlEncode
...
class CoderTest {
    ...
    fun testURLCoder() {
        ...
        val droidEncode = DroidURLCoder.encode(value)
        println(javaEncode)
        println(droidEncode)
        ...
        BasConfigurator.setURLCoder(DroidURLCoder)
